  ...
  return (
    <>
      <StyledSection>
        ...
        <ScrollAnimation>
          <div className='profile-container'>
            <div className='image-container'>
              <Image src='/assets/avatar.webp' alt='avatar' width={240} height={240} />
            </div>
            <div className='profile-contents'>
              <div>
                <Text as={'h2'} typography={'title-xl-bold'}>
                  Frontend Developer
                </Text>
              ...
              <div className='content'>
                <Text as={'h3'} typography={'title-l-bold'}>
                  Contact
                </Text>
                <div className='title'>
                  <Text typography={'text-xxl-bold'}>Email. </Text>
                  <Text typography={'text-xxl'}>
                    <Link href='mailto:ajcjcjc@gmail.com'>ajcjcjc@gmail.com</Link>
                  </Text>
                </div>
                <div className='title'>
              ...
              <div>
                ...
                <div className='title'>
                  ...
                  <Text typography={'text-xxl'}>
                    <Link href={BLOG_LINKS.github as string}>github.com/sh-oon</Link>
                  </Text>
                </div>
              </div>
            </div>
        ...
        <ScrollAnimation>
          <div className='profile-contents'>
            <Text as={'h3'} typography={'title-xxl-bold'}>
              Stack
            </Text>
            <hr />
            <div className='content'>
              <Text as={'h4'} typography={'title-l-bold'}>
                Frontend
              </Text>
              <Text as={'p'} typography={'title-xs-medium'}>
                Vue, React, Next.js, TypeScript
        ...
        <ScrollAnimation>
          <div className='profile-contents'>
            ...
            <StyledCareerContent>
              ...
              <Text as={'h4'} typography={'title-m-bold'}>
                2021.01 ~ 2021.06
              </Text>
              <Text as={'p'} typography={'title-xs-medium'}>
                프론트엔드 개발자
              ...
              <div>
                <ul>
                  <Text as={'li'} typography={'title-xs-medium'}>
                    제조 실행 시스템(MES) 플랫폼 고도화
                  </Text>
                  <Text as={'li'} typography={'title-xs-medium'}>
                    3D 건축설계 플랫폼 고도화
                  </Text>
